...
from tensorflow.keras.applications import ResNet50V2, NASNetLarge, NASNetMobile
...
class KerasResnetTrainer: 
    ...
    def __init__(self, name = 'resnet_tune',
                 num_classes = 5,
                 target_img_size=224,
                 batch_size=128,
                 as_SVM = False,
        ...
        process_res = preprocess_input(inputs)
        model = ResNet50V2(weights="imagenet", include_top=False,input_tensor = inputs, input_shape=(224, 224, 3))
        ...
        if as_SVM:
            ...
            class1 = layers.Dense(256,activation=tf.nn.relu)(flat1)
